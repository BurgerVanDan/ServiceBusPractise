...
namespace SimpleBrokeredMessaging.Receiver
{
    class ReceiverConsole
    {
        ...
        static string ConnectionString = "Endpoint=sb://sbpractise.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=Q7u1+6KPj4EaOvxv9KsmA40CCYLHmrRyFvKweZpxgCM=";
